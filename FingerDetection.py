...
def neuron_index(angle, total_neuron_number = 10):
    single_angle = 360.0 / total_neuron_number
...
def draw_circles(frame, traverse_point):
    if traverse_point is not None:
        for i in range(len(traverse_point)):
            cv2.circle(frame, traverse_point[i], int(5 - (5 * i * 3) / 100), [0, 255, 255], -1) # 黃色
...
def main():
    ...
    while capture.isOpened():
        ...
        # cv2.circle(frame, (100,100), 5, [0, 0, 255], -1) # 標記位置
        # cv2.circle(frame, (100,200), 5, [0, 255, 255], -1) # 標記位置
